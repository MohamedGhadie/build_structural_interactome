...
def main():
    ...
    # output data files
    modelAnnotatedInteractomeFile = modelBasedDir2 / 'model_annotated_interactome_11.txt'
    chainSeqFile = modelBasedDir2 / 'ppi_chain_sequences.pkl'
    chainMapFile = modelBasedDir2 / 'struc_interactome_chain_map.txt'
    modelInterfaceFile = modelBasedDir2 / 'model_interfaces_11.txt'
    chainStrucResFile = modelBasedDir2 / 'ppi_chain_strucRes.pkl'
    structuralInteractomeFile1 = modelBasedDir2 / 'structural_interactome_withDuplicates_11.txt'
    structuralInteractomeFile = modelBasedDir2 / 'structural_interactome_11.txt'

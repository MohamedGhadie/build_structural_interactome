...
def main():
    ...
    # directory of processed model-related data files specific to interactome
    modelBasedDir4 = interactomeDir / 'model_based_4'
    ...
    # output data files
    modelAnnotatedInteractomeFile = modelBasedDir4 / 'model_annotated_interactome_13.txt'
    chainSeqFile = modelBasedDir4 / 'ppi_chain_sequences.pkl'
    chainMapFile = modelBasedDir4 / 'struc_interactome_chain_map.txt'
    modelInterfaceFile = modelBasedDir4 / 'model_interfaces_13.txt'
    chainStrucResFile = modelBasedDir4 / 'ppi_chain_strucRes.pkl'
    structuralInteractomeFile1 = modelBasedDir4 / 'structural_interactome_withDuplicates_13.txt'
    structuralInteractomeFile = modelBasedDir4 / 'structural_interactome_13.txt'
    
    if not modelBasedDir.exists():
        os.makedirs(modelBasedDir)
    if not modelBasedDir4.exists():
        os.makedirs(modelBasedDir4)

...
def main():
    ...
    # output data files
    modelAnnotatedInteractomeFile = modelBasedDir4 / 'model_annotated_interactome_17.txt'
    chainSeqFile = modelBasedDir4 / 'ppi_chain_sequences.pkl'
    chainMapFile = modelBasedDir4 / 'struc_interactome_chain_map.txt'
    modelInterfaceFile = modelBasedDir4 / 'model_interfaces_17.txt'
    chainStrucResFile = modelBasedDir4 / 'ppi_chain_strucRes.pkl'
    structuralInteractomeFile1 = modelBasedDir4 / 'structural_interactome_withDuplicates_17.txt'
    structuralInteractomeFile = modelBasedDir4 / 'structural_interactome_17.txt'
